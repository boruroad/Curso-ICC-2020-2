...
public class Guerrero extends Personaje{
    ...
    public void combatir(Personaje atacado){
        ...
        int combate = atacado.getVida()-numero;
        atacado.setVida(combate);
        System.out.println("Quitamos "+combate+" de vida a "+atacado.getNombre());
        contadorCombate++;
    }
    ...
    public void cabalgar(Personaje atacado){
        ...
        int cabalga = atacado.getVida()-numero;
        atacado.setVida(cabalga);
        System.out.println("Quitamos "+cabalga+" de vida a "+atacado.getNombre());
        contadorCabalga++;
