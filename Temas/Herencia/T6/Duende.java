...
public class Duende extends Personaje{
    ...
    public void dobleDanio(Personaje atacado){
        ...
        int daño = g.nextInt(21-5)+5;
        if(jugada==1){
            int poder = atacado.getVida()-daño;
            atacado.setVida(poder);
            System.out.println("Quitamos "+poder+" de vida a "+atacado.getNombre());

        }

         if(jugada==2){
            int poder = atacado.getVida()-(daño*2);
            atacado.setVida(poder);
            System.out.println("Quitamos "+poder+" de vida a "+atacado.getNombre());
    ...
    public void chasquido(Personaje atacado){
        int numero = g.nextInt(6);
        int chasqueo = atacado.getVida()-numero;
        atacado.setVida(chasqueo);
        System.out.println("Quitamos "+chasqueo+" de vida a "+atacado.getNombre());
